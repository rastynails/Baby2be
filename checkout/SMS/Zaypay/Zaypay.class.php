...
class Zaypay 
{
     ...
     */
    public function create_payment ($locale, $method_id, $custom, $optional_amount = null) 
    {
        $XML  = $this->RequestURL("/{$optional_amount}/{$locale}/pay/{$this->price_setting_id}/payments/create?key={$this->price_setting_key}&payment_method_id={$method_id}&custom={$custom}");
        $oXML = $this->parseXML($XML);
