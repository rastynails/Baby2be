			...
			switch ( event.type ){
				...
				case 'mouseup': // DROP >> DROPEND >>
					...
					if ( drop.allowed ){
						...
						dropped = $.event.dispatch.call( drop.dropping, event ); // trigger "drop"
						}
					dropstart = false;
				...
				case drop.dropping && 'dropend': // DROPEND >> 
					$.event.dispatch.call( drop.dropping, event ); // trigger "dropend"
				...
				case drop.allowed && 'dropstart': // DROPSTART >> 
					...
					drop.dropping = $.event.dispatch.call( this, event )!==false ? this : null;
					break;
				}
			}
		},
