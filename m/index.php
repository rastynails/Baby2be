...
//define('SK_ERROR_REPORTING', E_ALL & ~E_NOTICE
...
define('DIR_INTERNALS', dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'internals' . DIRECTORY_SEPARATOR);

require_once 'mconfig.php';

$url_info = parse_url(MOBILE_SITE_DOMAIN);
if ( $_SERVER['HTTP_HOST'] != $url_info['host'] ) {
    header('Location: ' . MOBILE_SITE_DOMAIN);
}
...
require_once DIR_INTERNALS.'Smarty/Smarty.class.php';
require_once DIR_API.'QueryLogger.class.php';
require_once DIR_API.'Profiler.class.php';
require_once DIR_API.'MySQL.class.php';
SK_MySQL::connect();

require_once DIR_API.'Config.class.php';
