...
class component_CommentList extends SK_Component
{
	/**
	...
	{
        $tpl = isset($params['tpl']) ? $params['tpl'] : 'comment_list';
...
//		$ser = new SK_Service('read_blogs',$prof_id) ;
//
//		if($ser->checkPermissions() == SK_Service::SERVICE_FULL )
//		{
//
//			$ser->trackServiceUse();
//		}
//		else {
//			$ser->permission_message['message'];
//		}
//
	...
	{
		$handler = new SK_ComponentFrontendHandler('CommentList');
		$this->frontend_handler = $handler;

        $js_comm_array = array( 'entity_id' => $this->entity_id, 'entityType'=>$this->entityType, 'feature' => $this->feature, 'page' => $this->page, 'items' => array() );
	...
	/**
	 * Ajax method for paging navigation
	 *
	 * @param stdObject $params
	 * @param SK_ComponentFrontendHandler $handler
	 */
//	public static function ajax_getCommentList( $params, SK_ComponentFrontendHandler $handler )
//	{
//		$comment_list = new component_CommentList( $params->entity_id, $params->feature, $params->page );
//
//		$handler->updateCommentList( '<div>entity_id:'.$params->entity_id.'|feature:'.$params->feature.'|page:'.$params->page.'</div>' );
//	}
	...
	public static function ajax_deleteComment( $params, SK_ComponentFrontendHandler $handler, SK_AjaxResponse $response )
	{
		...
		self::reload( array( 'entity_id' => $params->entity_id, 'entityType'=>$params->entityType, 'feature' => $params->feature, 'page' => $page, 'mode' => $params->mode ), $handler, $response );
	}
}
