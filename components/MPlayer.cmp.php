...
class component_MPlayer extends SK_Component
{
	/**
	 * @var integer
	 */
	...
	public function __construct( array $params = null )
	{
		...
		$this->service = new SK_Service( 'm_player', $this->profile_id );		
	...
	{
		$handler = new SK_ComponentFrontendHandler('MPlayer');
	...
	public function render ( SK_Layout $Layout )
	{
		...
		$Layout->assign('html',($this->custom_html == null || $this->custom_html->getHtml_code() === null ? app_TextService::stOutputFormatter(SK_Language::text('components.m_player.default_html'),'profile_view', false): app_TextService::stOutputFormatter($this->custom_html->getHtml_code(),'profile_view', false)));
	...
	public function handleForm( SK_Form $form)
	{
		...
		$form->frontend_handler->bind("success", "function(data) {
			this.ownerComponent.submitMPlayerCode({cmp_id:$this->cmp_id,profile_id:$this->profile_id});
		}");
