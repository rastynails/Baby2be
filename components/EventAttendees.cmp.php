...
class component_EventAttendees extends SK_Component
{
	/**
	 * @var Event
	 */
	...
	{
		parent::__construct( 'event_attendees' );
	...
	{
		$profiles = $this->event_service->findAttendingProfileIdsForEvent( $this->event->getId(), true );
		
		$Layout->assign( 'count', $this->event_service->findAttendingProfilesCount( $this->event->getId() ) );
		...
		$Layout->assign( 'profile_list', new component_ThumbedProfileList( $profiles ) );
