...
class httpdoc_Attendees extends SK_HttpDocument
{
	/**
	...
	public function render( SK_Layout $Layout )
	{
		...
		SK_Navigation::addBreadCrumbItem( SK_Language::section( 'event' )->text( 'attendees' ) );
	...
	{
		return SK_Navigation::href( 'event_attendees', array( 'eventId' => $event_id ) );
	}
