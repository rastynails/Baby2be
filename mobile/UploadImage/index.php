...
{$uploadtype=$_POST["upload_type"];
          $return	=	$usr->ImageUpload($_POST["id"],$uploadtype);
            ...
            $tmp            =       '/$userfiles/thumb_'.$profile.'_'.$photo.'_'.$index.'.jpg';
       ...
       // unlink($newname);
		echo '{"Status":"Live","Message":"Image Uploaded","Path":"'.$thumbimg.'","UploadType":"'.$uploadtype.'"}';
...
//$url;
//"'$url'./member\/photos\/'.$username.'\/'.$eid.'","photo_src":"'$url'./userfiles\/'.$thumbimg.'"
		$data='{"string":"photo_upload","content":{"photo_url":"'.$url.'/member/photos/'.$username.'/'.$eid.'","photo_src":"'.$url.'/'.$tmp.'"}}';
