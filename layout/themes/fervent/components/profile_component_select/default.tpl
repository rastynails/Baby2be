...
<div class="block_info">
    ...
    <div style="text-align:right;padding: 0px 2px 7px 0px;float:right;width:30%;"><input type="button" {id="input"} value="{text %.components.profile_cmp_select.add_button_label}" /></div><div style="clear:both"></div>
</div>
