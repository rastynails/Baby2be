	...
	{foreach from=$topics item=topic}
		<li class="item">
			...
			<div class="list_block">
				<div class="list_info">
					<div class="item_title"><a href="{document_url doc_key='topic' topic_id=$topic.forum_topic_id}">{$topic.title|out_format:"comment"|censor:'forum'}</a></div>
					{text %posted_by} 
...
{/if}
<div class="forum_btn">	<a href="{document_url doc_key='forum_group_list'}"><span>{text %go_to_forum}</span></a>
</div>
{/block}
