...
{block}
{block_cap title=$label_shoutbox}<div class="shoutbox_bumbox"></div>{/block_cap}
...
<ul style="display: none">
	...
	<li {id="message_tpl"}  class="clearfix">
        ...
        <div class="shoutbox_body">
            <a href="#" class="msg_username"></a>:&nbsp;<span class="msg_text"></span><br />
...
<form {id="shoutbox_input_form"} onsubmit="return false">
			...
			<div class="clearfix">
				<div class="shoutbox_right">
				    {if $is_guest}					
					<input type="text" {id="username"} name="username" class="shoutbox_input" size="14" value="guest" />
                    {$username_invitation}
				    {/if}
				</div>
