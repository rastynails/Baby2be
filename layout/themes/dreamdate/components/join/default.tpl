	...
	{block title=%label}
			...
			{if $has_captcha}
				...
				<table class="form">
					<thead>
						<tr>
							<th class="{cycle values='th1,th2,th3,th4'}" colspan="2">{label %captcha_label for="captcha"}</th>
						</tr>
					</thead>
					<tbody>
				...
				<br clear="all">	
			{/if}
			<p align="center">{button action=$form->active_action label=%.forms._actions.join}</p>	
