...
{else}
	...
	<table>
	<tr>
		<td><label style="white-space: nowrap;"><input type="radio" {id="upload_radio"} name="image_select" /> {text %.components.profile_background.field_label_upload_image}</label></td>
	...
	<tr>
		<td><label style="white-space: nowrap;"><input type="radio" {id="url_radio"} name="image_select" /> {text %.components.profile_background.field_label_image_url}</label></td>
