...
{block_cap title=%.components.profile_preference.configs.blogs.title}
...
{block}
        ...
        {foreach from=$bp_list item='blog_entry'}
            <li class="item">
                ...
                <div class="list_block">
                    ...
                    <div class="list_content">{$blog_entry.desc|censor:'blog'|smile|out_format:'blog'|censor:'blog'}</div>
                </div>
                <div class="clr"></div>
            </li>
        {/foreach}
	...
	<div class="clearfix"><div class="block_toolbar"><a href="{$blogs_url}">{text %.blogs.label_view_all}</a></div></div>
        {/if}
    </div>
