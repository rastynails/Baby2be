...
{block}	
    ...
    {foreach from=$bp_list item='blog_entry'}
        <li class="item">
            ...
            <div class="list_block">
            	<div class="list_info">
                	<div class="item_title"><a href="{$blog_entry.blog_post_url}">{$blog_entry.title|censor:'blog'}</a></div>
    ...
    <div class="clearfix"><div class="block_toolbar"><a href="{$news_url}">{text %.blogs.label_view_all}</a></div></div>
    {/if}
{/block}
{/container}
