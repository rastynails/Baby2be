...
{block}
{block_cap title=%label toolbar=$smarty.capture.toolbar}
...
<ul class="thumb_text_list">
	{foreach from=$items_list.offer item=item}
		<li class="item">
			<div class="list_thumb">
				{cls_thumb thumb=$item.item_thumb  title=$item.title|censor:'classifieds':true size='60' href=$item.item_url}
			</div>
			<div class="list_block">
				<div class="list_info">
