...
{container stylesheet="cls_item_list.style" class="cls_item_list"}

{block class="item_list"}
    {block_cap title=%.components.cls.search_result}
    ...
    <table width="100%">
        <tbody>
            ...
            <tr>
                ...
                <td class="list_item">
                    <b>{text %.components.cls.`$item.entity`}</b>: <a href="{document_url doc_key='classifieds_item' item_id=$item.item_id}">{$item.title}</a><br/>
